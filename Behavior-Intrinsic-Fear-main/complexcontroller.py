...
class SiameseNetwork(nn.Module):
    def __init__(self, image_input_shape, vector_input_dim2,vector_input_dim,
        ...
        self.image_branch = nn.Sequential(
            nn.Conv2d(image_input_shape[0], 32, 8, stride=4),
            nn.ReLU(),
            nn.Conv2d(32, 100, 4, stride=2),
            nn.ReLU(),
            nn.Conv2d(100, 100, 3, stride=1),
            nn.ReLU())
        ...
        self.image_fc = nn.Sequential(
             nn.Linear(4902 , embedding_dim),#the 2 is for the delimeter
             # nn.Linear(80002 , embedding_dim),#the 2 is for the delimeter
